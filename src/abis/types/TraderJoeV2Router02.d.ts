...
interface TraderJoeV2Router02Interface extends ethers.utils.Interface {
  functions: {
...
export class TraderJoeV2Router02 extends BaseContract {
  ...
  interface: TraderJoeV2Router02Interface;
